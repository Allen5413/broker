...
public class ExcelUtil {
     ...
     * @param eob excel数据
     */
    public static String writeExcelFile(ExcelObject eob, Map<Integer, Integer> columnWidthMap, String fileName){
        ...
        try{
            ...
            throw new BusinessException("写入excel出现异常", e);
        }
        return fileName;
    }
}
