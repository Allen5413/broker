...
public class PageProjectController extends BaseController {

    @Autowired
    private PageProjectService pageProjectService;
    ...
    public String find(HttpServletRequest request) throws Exception {
        ...
        pageInfo = pageProjectService.find(pageInfo, params, sortMap);
